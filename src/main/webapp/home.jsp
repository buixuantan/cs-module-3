    ...
    <div class="sidebar">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <c:forEach var="o1" items="${listCategory}">
                    <li>
                        <a href="home-page?id=${o1.id}">${o1.name}</a>
                    </li>
                </c:forEach>
                            ...
                            <div class="col-lg-9">
                                <div class="right_header_info">
                                    <ul>
                                        ...
                                        <li class="menu_iconb">
                                            <a href="#">Log in <img style="margin-right: 15px;" src="../icon/5.png"
                                                                    alt="#"/> </a>
                                        </li>
                                        <li class="menu_iconb">
                                            <a href="#">Signup<img style="margin-left: 15px;" src="../icon/6.png"
                                                                   alt="#"/></a>
                                        </li>
                                        <li class="tytyu">
                        ...
                        <div class="title">
                            ...
                            <ul class="categiri">
                                <c:forEach var="o" items="${listCategory}">
                                    <li class="active"><a href="home-page?id=${o.id}">${o.name}</a></li>
                                </c:forEach>
                                <li><a href="../home-page">Home and Garden</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <c:forEach var="o" items="${listProduct}" >
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 margintop">
                                ...
                                <a class="buynow" href="product?action=buy&pId=${o.id}">Buy now</a>
                            </div>
                        </c:forEach>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="footer_top">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <a href="../xxxx.html"> <img class="logo1" src="../images/logo1.png"/></a>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <ul class="sociel">
